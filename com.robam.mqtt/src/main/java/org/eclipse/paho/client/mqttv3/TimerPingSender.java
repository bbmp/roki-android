...
public class TimerPingSender implements MqttPingSender {
	...
	public void start() {
		...
		if (log != null) log.fine(CLASS_NAME, methodName, "659", new Object[]{clientid});
	...
	public void stop() {
		...
		//@Trace 661=stop
		if (log != null) log.fine(CLASS_NAME, methodName, "661", null);
		if(timer != null){
			timer.cancel();
		}
	}
	...
	private class PingTask extends TimerTask {
		...
		public void run() {
			...
			if (log != null) log.fine(CLASS_NAME, methodName, "660", new Object[]{new Long(System.currentTimeMillis())});
