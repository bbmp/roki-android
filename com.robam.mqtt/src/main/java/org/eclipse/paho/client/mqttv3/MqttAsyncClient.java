...
public class MqttAsyncClient implements IMqttAsyncClient { // DestinationProvider {
    ...
    static WeakReference<MqttAsyncClient> weakReference;
    static MqttAsyncClient asyncClient;

    public static MqttAsyncClient getInstance(String serverURI, String clientId, MqttClientPersistence persistence, MqttPingSender pingSender, String haxCode) throws MqttException {
        stop();
        if (weakReference == null || weakReference.get() == null) {
            weakReference = new WeakReference<>(new MqttAsyncClient(serverURI, clientId, persistence, pingSender, haxCode));
        }
//        asyncClient = new MqttAsyncClient(serverURI, clientId, persistence, pingSender, haxCode);
        return weakReference.get();
    }

    public static void stop() throws MqttException {
        if (weakReference != null && weakReference.get() != null) {
            weakReference.get().disconnectForcibly();
...
//            asyncClient = null;
//        }
        Log.i("20180225", "MqttAsyncClient stop 关闭 ");
    }
     ...
     * @throws MqttException            if any other problem was encountered
     */
    public MqttAsyncClient(String serverURI, String clientId, MqttClientPersistence persistence, MqttPingSender pingSender, String haxCode) throws MqttException {
        ...
        this.comms = new ClientComms(this, this.persistence, pingSender, haxCode);
    ...
    protected NetworkModule[] createNetworkModules(String address, MqttConnectOptions options) throws MqttException {
        ...
        // @TRACE 116=URI={0}
        if (log != null) log.fine(CLASS_NAME, methodName, "116", new Object[]{address});
        ...
        if (log != null) log.fine(CLASS_NAME, methodName, "108");
    ...
    private NetworkModule createNetworkModule(String address, MqttConnectOptions options) throws MqttException {
        ...
        // @TRACE 115=URI={0}
        if (log != null) log.fine(CLASS_NAME, methodName, "115", new Object[]{address});
...
//				}
    ...
    public IMqttToken connect(MqttConnectOptions options, Object userContext, IMqttActionListener callback)
        ...
        if (log != null) log.fine(CLASS_NAME, methodName, "103",
                new Object[]{
    ...
    public IMqttToken disconnect(long quiesceTimeout, Object userContext, IMqttActionListener callback) throws MqttException {
        ...
        try {
            ...
            //@TRACE 105=< exception
            if (log != null) log.fine(CLASS_NAME, methodName, "105", null, ex);
            throw ex;
        }
        //@TRACE 108=<
        if (log != null) log.fine(CLASS_NAME, methodName, "108");
    ...
    public IMqttToken checkPing(Object userContext, IMqttActionListener callback) throws MqttException {
        ...
        MqttToken token;
        //@TRACE 117=>
        if (log != null) log.fine(CLASS_NAME, methodName, "117");

        token = comms.checkForActivity();
        //@TRACE 118=<
        if (log != null) log.fine(CLASS_NAME, methodName, "118");
    ...
    public IMqttToken subscribe(String[] topicFilters, int[] qos, Object userContext, IMqttActionListener callback) throws MqttException {
        ...
        //@TRACE 109=<
        if (log != null) log.fine(CLASS_NAME, methodName, "109");
    ...
    public IMqttToken unsubscribe(String[] topicFilters, Object userContext, IMqttActionListener callback) throws MqttException {
        ...
        //@TRACE 110=<
        if (log != null) log.fine(CLASS_NAME, methodName, "110");
...
//                try {
//                    MqttAsyncClient client = getInstance(null, null, null, null, null);
//                    client.connect(options, userContext, new IMqttActionListener() {
//                        @Override
...
//        };
    ...
    public IMqttDeliveryToken publish(String topic, MqttMessage message, Object userContext, IMqttActionListener callback) throws MqttException {
        ...
        //@TRACE 112=<
        if (log != null) log.fine(CLASS_NAME, methodName, "112");
    ...
    public void close() throws MqttException {
        ...
        //@TRACE 113=<
        if (log != null) log.fine(CLASS_NAME, methodName, "113");
        comms.close();
        //@TRACE 114=>
        if (log != null) log.fine(CLASS_NAME, methodName, "114");
