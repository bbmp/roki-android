...
public class Debug {
	...
	public Debug(String clientID, ClientComms comms) {
		...
		this.comms = comms;
		if (log != null) log.setResourceName(clientID);
	}
	...
	protected void dumpVersion() {
		...
		if (log != null) log.fine(CLASS_NAME,"dumpVersion", vInfo.toString());
	}
	...
	public void dumpSystemProperties() {
    	...
    	if (log != null) log.fine(CLASS_NAME,"dumpSystemProperties", dumpProperties(sysProps, "SystemProperties"));
	}
	...
	public void dumpClientState() {
	    ...
	    if (comms != null && comms.getClientState() != null ) {
	    	...
	    	if (log != null) log.fine(CLASS_NAME,"dumpClientState", dumpProperties(props, clientID + " : ClientState"));
	    }
	}
	...
	public void dumpClientComms() {
	    ...
	    if (comms != null) {
	    	...
	    	if (log != null) log.fine(CLASS_NAME,"dumpClientComms", dumpProperties(props, clientID + " : ClientComms"));
	    }
	}
	...
	public void dumpConOptions() {
	    ...
	    if (comms != null) {
	    	...
	    	if (log != null) log.fine(CLASS_NAME,"dumpConOptions", dumpProperties(props, clientID + " : Connect Options"));
	    }
	}
