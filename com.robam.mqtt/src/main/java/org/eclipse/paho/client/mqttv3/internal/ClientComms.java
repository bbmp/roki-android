...
public class ClientComms {
    ...
    public String haxCode;

    /**
     * Creates a new ClientComms object, using the specified module to handle
     * the network calls.
     */
    public ClientComms(IMqttAsyncClient client, MqttClientPersistence persistence, MqttPingSender pingSender, String hc) throws MqttException {
        ...
        if (log != null) log.setResourceName(getClient().getClientId());
    }
    ...
    void internalSend(MqttWireMessage message, MqttToken token) throws MqttException {
        ...
        if (log != null) log.fine(CLASS_NAME, methodName, "200", new Object[]{message.getKey(), message, token});
        ...
        if (token.getClient() == null) {
            ...
            if (log != null) log.fine(CLASS_NAME, methodName, "213", new Object[]{message.getKey(), message, token});
    ...
    public void sendNoWait(MqttWireMessage message, MqttToken token) throws MqttException {
        ...
        if (isConnected() ||
            ...
            if (log != null) log.fine(CLASS_NAME, methodName, "208");
        ...
        synchronized (conLock) {
            if (!isClosed()) {
                ...
                if (!isDisconnected()) {
                    ...
                    if (log != null) log.fine(CLASS_NAME, methodName, "224");
    ...
    public void connect(MqttConnectOptions options, MqttToken token) throws MqttException {
        ...
        synchronized (conLock) {
            if (isDisconnected() && !closePending) {
                ...
                if (log != null) log.fine(CLASS_NAME, methodName, "214");
                ...
                if (log != null) log.fine(CLASS_NAME, methodName, "207", new Object[]{new Byte(conState)});
    ...
    public void connectComplete(MqttConnack cack, MqttException mex) throws MqttException {
        ...
        synchronized (conLock) {
            if (rc == 0) {
                ...
                if (log != null) log.fine(CLASS_NAME, methodName, "215");
        ...
        if (log != null) log.fine(CLASS_NAME, methodName, "204", new Object[]{new Integer(rc)});
        throw mex;
    }
    ...
    public void shutdownConnection(MqttToken token, MqttException reason) {
        ...
        synchronized (conLock) {
            ...
            if (log != null) log.fine(CLASS_NAME, methodName, "216");
        ...
        synchronized (conLock) {
            ...
            if (log != null) log.fine(CLASS_NAME, methodName, "217");
    ...
    private MqttToken handleOldTokens(MqttToken token, MqttException reason) {
        ...
        //@TRACE 222=>
        if (log != null) log.fine(CLASS_NAME, methodName, "222");
    ...
    public void disconnect(MqttDisconnect disconnect, long quiesceTimeout, MqttToken token) throws MqttException {
        ...
        synchronized (conLock) {
            if (isClosed()) {
                ...
                if (log != null) log.fine(CLASS_NAME, methodName, "223");
                ...
                if (log != null) log.fine(CLASS_NAME, methodName, "211");
                ...
                if (log != null) log.fine(CLASS_NAME, methodName, "219");
                ...
                if (log != null) log.fine(CLASS_NAME, methodName, "210");
            ...
            if (log != null) log.fine(CLASS_NAME, methodName, "218");
            conState = DISCONNECTING;
    ...
    private class ConnectBG implements Runnable {
        ...
        public void run() {
            ...
            //@TRACE 220=>
            if (log != null) log.fine(CLASS_NAME, methodName, "220");
            ...
            try {
                ...
                if (log != null) log.fine(CLASS_NAME, methodName, "212", null, ex);
                mqttEx = ex;
            } catch (Exception ex) {
                //@TRACE 209=connect failed: unexpected exception
                if (log != null) log.fine(CLASS_NAME, methodName, "209", null, ex);
    ...
    private class DisconnectBG implements Runnable {
        ...
        public void run() {
            ...
            //@TRACE 221=>
            if (log != null) log.fine(CLASS_NAME, methodName, "221");
    ...
    private void handleRunException(Exception ex) {
        ...
        //@TRACE 804=exception
        if (log != null) log.fine(CLASS_NAME, methodName, "804", null, ex);
        MqttException mex;
