...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        float conrnerRadius = a.getDimensionPixelSize(
                R.styleable.RoundImageView_riv_corner_radius, 0);

        if (conrnerRadius > 0) {
            mLeftTopCornerRadius = conrnerRadius;
            mRightTopCornerRadius = conrnerRadius;
            mLeftBottomCornerRadius = conrnerRadius;
            mRightBottomCornerRadius = conrnerRadius;
        }
