...
import com.legent.utils.ListUtils;
import com.legent.utils.LogUtils;
import com.legent.utils.ShellUtils;
import com.legent.utils.ShellUtils.CommandResult;
...
public class PackageUtils {
    ...
    public static final int GET_UNKNOWN_APP_SOURCES = 87;
    ...
    public static int getVersionCode(Context cx) {
        ...
        try {
            PackageInfo pi = pm.getPackageInfo(cx.getPackageName(), 0);
    ...
    public static void installApk(Context cx, Uri uri) {
        PreferenceUtils.setString("downloaduri",uri.toString());
        Activity mActivty = (Activity) cx;
        if (cx.getPackageManager().canRequestPackageInstalls()) {
            File file = null;
            try {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                Uri apkUri = FileProvider.getUriForFile(cx, "roki", file);
            ...
            mActivty.startActivityForResult(intent, GET_UNKNOWN_APP_SOURCES);
        }
    ...
    public void onEvent(ActivityResultOnPageEvent event) {
        ...
        LogUtils.i("201912057777","data1:::"+data);
        LogUtils.i("201912057777","data2:::"+data.toUri(PackageUtils.GET_UNKNOWN_APP_SOURCES));
        LogUtils.i("201912057777","data3:::"+data.toString());
        switch (requestCode) {
            case PackageUtils.GET_UNKNOWN_APP_SOURCES:
                if (resultCode==RESULT_OK) {
                    LogUtils.i("201912057777","data4:::");
//                    PackageUtils.installApk(cx,);
                }
                break;
        }
