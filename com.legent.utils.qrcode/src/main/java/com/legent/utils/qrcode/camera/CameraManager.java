...
package com.legent.utils.qrcode.camera;
...
public final class CameraManager {
	...
	private static final int MAX_FRAME_WIDTH = 480*3/2;
	private static final int MAX_FRAME_HEIGHT = 360*3/2;
	...
	public void setLight(boolean light) {
		if (camera != null) {
			...
			String mode = light ? Parameters.FLASH_MODE_TORCH
					: Parameters.FLASH_MODE_OFF;

			parameter.setFlashMode(mode);
