...
//        }
    ...
    private void layoutImageView(RatioImageView imageView, int i, String url) {
        ...
        if (i==2&&isShowMore){
            TextView textView= (TextView) LayoutInflater.from(mContext).inflate(R.layout.nine_picture_view_mask,null,false);
            textView.layout(left, top, right, bottom);
            textView.setText("...\n共"+mSize+"张");
            textView.setGravity(Gravity.CENTER);


            float rm=getHeight(textView.getPaint());
            textView.setPadding( textView.getPaddingLeft(), (int) (textView.getWidth()/2-rm), textView.getPaddingRight(),0);
    ...
    protected abstract void displayImage(int position,View imageView, String url);
