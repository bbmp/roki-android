...
public class FanCtr66A2View extends FrameLayout implements UIListeners.IFanCtrView {
    ...
    public FanCtr66A2View(Context context) {
        super(context);
        init(context, null);
    }

    public FanCtr66A2View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
