package com.robam.roki.ui.view.linkrecipetag;
/*
...
import com.robam.roki.ui.view.linkrecipetag.adapter.LinkagePrimaryAdapter;
import com.robam.roki.ui.view.linkrecipetag.adapter.LinkageSecondaryAdapter;
...
import com.robam.roki.ui.view.linkrecipetag.defaults.DefaultLinkagePrimaryAdapterConfig;
import com.robam.roki.ui.view.linkrecipetag.defaults.DefaultLinkageSecondaryAdapterConfig;
import com.robam.roki.ui.view.linkrecipetag.manager.RecyclerViewScrollHelper;
...
//                    if (mPrimaryAdapter.getSelectedPosition() == mPrimaryAdapter.getItemCount() -1){
//                        mPrimaryAdapter.setSelectedPosition(lastCompletelyVisibleItemPosition);
...
//                    }
                    for (int i = 0; i < groupNames.size(); i++) {
                        if (groupNames.get(i).equals(mLastGroupName)) {
                            if (mPrimaryClicked) {
                                ...
                                if (mPrimaryAdapter.getSelectedPosition() == groupNames.size() -1){
                                    mPrimaryClicked = false;
                                }
                            } else {
                                if (mPrimaryAdapter.getSelectedPosition() == mPrimaryAdapter.getItemCount() -1  && isEnd){
                                    isEnd = false;
                                    return;
                                }
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                int lastCompletelyVisibleItemPosition = mSecondaryLayoutManager.findLastCompletelyVisibleItemPosition();
