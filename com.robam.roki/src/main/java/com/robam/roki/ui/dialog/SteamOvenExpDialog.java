...
public class SteamOvenExpDialog extends AbsDialog {
    ...
    int min;
    int max;
    public SteamOvenExpDialog(Context context, List<Integer> tempUp, List<Integer> tempDwon,
    ...
    public void show(SteamOvenExpDialog absSetting) {
