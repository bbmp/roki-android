    ...
    class RecipeListAdapter extends ListAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!StringUtils.isNullOrEmpty(recipeShow.ownerFigureUrl)) {//头像图
                ...
                ImageUtils.displayImage(recipeShow.ownerFigureUrl, viewHolder.recipe_dynamic_imgv_headic, options.showImageOnLoading(R.mipmap.ic_recipe_headicon_roki).build());
            } else {
