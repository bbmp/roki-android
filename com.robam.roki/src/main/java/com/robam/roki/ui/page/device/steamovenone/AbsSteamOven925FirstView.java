...
public class AbsSteamOven925FirstView extends FrameLayout{
    Context cx;
    ...
    SteamOven925CommonAdapter steamOvenCommonAdapter;


    public AbsSteamOven925FirstView(Context context, List<DeviceConfigurationFunctions> mainList, List<DeviceConfigurationFunctions> otherList) {
        super(context);
        this.cx = context;
    ...
    public AbsSteamOven925FirstView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.cx = context;
        initView();
    }
    ...
    private void initView() {
        View view = LayoutInflater.from(cx).inflate(R.layout.steamoven_925_first_view, this, true);
        if (!view.isInEditMode()) {
            ButterKnife.inject(this, view);
        }

        steamOvenCommonAdapter = new SteamOven925CommonAdapter(cx,mainList,otherList);
        ...
        steamOvenCommonAdapter.setGridViewOnclickLister(new SteamOven925CommonAdapter.GridViewOnclick() {
            @Override
        ...
        steamOvenCommonAdapter.setItemViewOnclickLister(new SteamOven925CommonAdapter.ItemViewOnclick() {
