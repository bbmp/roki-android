 ...
 */
public class DeviceModelWheel extends View {
    ...
    public DeviceModelWheel(Context context, AttributeSet attrs,
                            int defStyle) {
    ...
    public DeviceModelWheel(Context context) {
        super(context);
        initData();
    }
   ...
   //     drawMask(canvas);
    ...
    private int chooseRes(int i, boolean isSelected) {
        ...
        switch (i) {
            case 0:
                ans = isSelected ? R.mipmap.ic_device_microwave_normal_barbecue : R.mipmap.ic_device_microwave_normal_barbecue;
                break;
            case 1:
                ans = isSelected ? R.mipmap.ic_device_microwave_normal_microwave : R.mipmap.ic_device_microwave_normal_microwave;
                break;
            case 2:
                ans = isSelected ? R.mipmap.ic_device_microwave_normal_microwave_combinedheating : R.mipmap.ic_device_microwave_normal_microwave_combinedheating;
                break;
            default:
                break;
        }
    ...
    private void onSelectListener() {
        Log.i("mic", "onSelectListener11");

        if (onSelectListener == null)
            return;
        Log.i("mic", "onSelectListener22");
        for (ItemObject item : itemList) {
            if (item.isSelected()) {
                onSelecting(item);
            }
