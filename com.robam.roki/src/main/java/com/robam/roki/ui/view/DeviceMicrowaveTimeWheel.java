 ...
 */
public class DeviceMicrowaveTimeWheel extends View {
    ...
    public DeviceMicrowaveTimeWheel(Context context, AttributeSet attrs,
                                    int defStyle) {
    ...
    public DeviceMicrowaveTimeWheel(Context context) {
        super(context);
        initData();
    }
...
//            setMeasuredDimension(getWidth(), itemNumber * unitHeight - (itemNumber / 2) * (itemNumber / 2 + 1) * heightDiv);
            setMeasuredDimension(getWidth(), controlHeight);
            controlWidth = getWidth();
...
//        canvas.drawRect(unitHeight/2, controlHeight / 2 - unitHeight / 2 + 2, controlWidth, controlHeight / 2 + unitHeight / 2, paint);
    ...
    protected class ItemObject {
        ...
        protected void drawSelf(Canvas canvas) {
            ...
            if (Build.VERSION.SDK_INT >= 26){
                if (startx_offset != 0) {
                    canvas.drawText(itemText + " " + unit, x + startx_offset + 50, y + move + unitHeight / 2 + textRect.height() / 2,
                            textPaint);
                }else {
                    canvas.drawText(itemText + " " + unit, x + controlWidth + 50, y + move + unitHeight / 2 + textRect.height() / 2,
                            textPaint);
                }
            }else {
                if (startx_offset != 0) {
