...
public class AbsOvenModeSettingHasDbDialog extends AbsDialog {
    ...
    public AbsOvenModeSettingHasDbDialog(
                                    Context context,
                                    List<Integer> temp,
                                    List<Integer> time,
                                    List<String> liststr,
    ...
    public interface PickListener {
        ...
        void onConfirm(int index1, int index2,boolean isOpen,boolean isClose);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.confirm:
                if (listener!=null){
                    ...
                    listener.onConfirm(temp.get(indexSelectTemp),time.get(indexSelectTime),isOpen,isClose);
                }
                this.dismiss();
                break;
        }
    ...
    public void show(AbsOvenModeSettingHasDbDialog absSetting) {
