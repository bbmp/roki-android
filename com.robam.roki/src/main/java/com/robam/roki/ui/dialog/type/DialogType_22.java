 ...
 *
 */
public class DialogType_22 extends BaseDialog {

    private TextView mTvCancel;
    private TextView mTvConfirm;
    private TextView mTvDesc;

    public DialogType_22(Context context) {
        super(context);
    }
    ...
    public void setWheelViewData(List<String> listFrnot, List<String> listCenter, List<String> listRear,
        ...
        listMin.addAll(listRear);
        LogUtils.i("2020063005","listFrnot:::"+listFrnot.toString());
        mLoopViewFront.setItems(listFrnot);
        //mLoopViewRear.setItems(listRear);
        mLoopViewRear.setItems(listMin);
    ...
    public void bindAllListeners() {
        ...
        mLoopViewFront.setListenerFrone(new OnItemSelectedListenerFrone() {
            ...
            public void onItemSelectedFront(String contentFront) {
                ...
                if (listFrnot!=null&&listFrnot.size()>0) {
                    if ((listFrnot.get(listFrnot.size()-1)).equals(contentFront)) {
                        if (listMin!=null) {
                            listMin.clear();
                            listMin.add("0分钟");
                            onTouchWheelSelectedRear(listMin.get(0));
                            mLoopViewRear.setCurrentPosition(0);
                            mLoopViewRear.setItems(listMin);
                        }
                ...
                if ("0".equals(frontText) && "0".equals(rearText)){
                    onTouchWheelSelectedRear(listMin.get(1));
