...
//        banner = (Banner) view.findViewById(R.id.recipethemebanner);
        ...
        firebaseAnalytics.setCurrentScreen((Activity) cx, "美食页", null);
        ...
        CookbookManager.getInstance().getConsultationList(page, size, new Callback<List<RecipeConsultation>>() {
            ...
            public void onSuccess(List<RecipeConsultation> list) {
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    ImageUtils.displayImage(recipeConsultations.get(i).imageUrl, imgb, options.displayer(new NewRoundBitmapDisplayer(20))
