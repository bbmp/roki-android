...
public class RecipeDetailView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public RecipeDetailView(Context context, ArrayList<CookStep> cookStepTemp, IDevice iDevice) {
        super(context);
        this.cx = context;
    ...
    void init(Context cx) {
        View view = LayoutInflater.from(cx).inflate(R.layout.page_recipe_step_view,
                this, true);
    ...
    public class CardAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            myViewHolder.recipe_desc.setText(textSpan);
