 ...
 */
public class SpecialWheelView extends View {
    ...
    public SpecialWheelView(Context context, AttributeSet attrs,
                         int defStyle) {
    ...
    public SpecialWheelView(Context context) {
        super(context);
        initData();
    }
...
//            setMeasuredDimension(getWidth(), itemNumber * unitHeight - (itemNumber / 2) * (itemNumber / 2 + 1) * heightDiv);
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            // 绘制内容
            canvas.drawText(itemText, x + 80, y + move + unitHeight / 2 + textRect.height() / 2,
                    textPaint);
