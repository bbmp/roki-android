 ...
 */
public class DialogType_16 extends BaseDialog {

    private TextView mOkTv;
    private TextView mContentTv;

    public DialogType_16(Context context) {
        super(context);
    }

    @Override
    public void initDialog() {
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.common_dialog_layout_type_16, null);
