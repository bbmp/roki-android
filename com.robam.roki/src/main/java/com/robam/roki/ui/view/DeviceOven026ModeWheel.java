 ...
 */
public class DeviceOven026ModeWheel extends View {
    ...
    public DeviceOven026ModeWheel(Context context, AttributeSet attrs,
                                  int defStyle) {
    ...
    public DeviceOven026ModeWheel(Context context) {
        super(context);
        initData();
    }
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            canvas.drawText(itemText, x + 140, y + move + unitHeight / 2 + textRect.height() / 2 + 10,
                    textPaint);
