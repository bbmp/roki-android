...
public class DeviceSteameC906ModeWheel extends View{
    ...
    public DeviceSteameC906ModeWheel(Context context, AttributeSet attrs,
                                   int defStyle) {
    ...
    public DeviceSteameC906ModeWheel(Context context) {
        super(context);
        initData();
    }
    ...
    private void initData() {
        ...
        list.add(getContext().getString(R.string.device_steamOvenOne_name_faXiao));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_xianNenZheng));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_yingYangZheng));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_gaoWenZhen));
    ...
    private int chooseRes(int i, boolean isSelected) {
        ...
        switch (i) {
            case 0:
                ans = isSelected ? R.mipmap.faxiao_icon : R.mipmap.faxiao_icon;
                break;
            case 1:
                ans = isSelected ? R.mipmap.xiannenzheng_icon : R.mipmap.xiannenzheng_icon;
                break;
            case 2:
                ans = isSelected ? R.mipmap.yingyag_icon : R.mipmap.yingyag_icon;

                break;
            case 3:
                ans = isSelected ? R.mipmap.gaowen_icon : R.mipmap.gaowen_icon;
                break;
        }
        return ans;
    }
        ...
        public void drawSelf(Canvas canvas) {
            ...
            if (width < 28 || height < 28){
                ...
                if (itemText.length() == 3){
                    ...
                    canvas.drawText(itemText, x + 45, y + move + unitHeight-20, textPaint);
                }
...
//            canvas.drawText(itemText, x + 40, y + move + unitHeight / 2 + textRect.height() / 2, textPaint);
                ...
                if(itemText.length() == 3){
                    canvas.drawText(itemText, x + 30, y + move + unitHeight, textPaint);
                }else {
                    canvas.drawText(itemText, x + 45, y + move + unitHeight, textPaint);
                }
