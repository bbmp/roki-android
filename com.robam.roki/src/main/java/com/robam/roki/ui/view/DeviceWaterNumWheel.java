...
public class DeviceWaterNumWheel extends View {
    ...
    public DeviceWaterNumWheel(Context context, AttributeSet attrs,
                               int defStyle) {
    ...
    public DeviceWaterNumWheel(Context context) {
        super(context);
        initData();
    }
...
//            setMeasuredDimension(getWidth(), itemNumber * unitHeight - (itemNumber / 2) * (itemNumber / 2 + 1) * heightDiv);
    ...
    protected void drawLine(Canvas canvas) {
        ...
        canvas.drawLine(unitHeight/2-30,controlHeight / 2 - unitHeight / 2, controlWidth - unitHeight-16, controlHeight / 2 - unitHeight / 2, paint);
        canvas.drawLine(unitHeight/2-30,controlHeight / 2 + unitHeight / 2, controlWidth - unitHeight-16, controlHeight / 2 + unitHeight / 2, paint);
    }
