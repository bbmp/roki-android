...
public class DeviceAssistC906ModeWheel extends View{
    ...
    public DeviceAssistC906ModeWheel(Context context, AttributeSet attrs,
                                     int defStyle) {
    ...
    public DeviceAssistC906ModeWheel(Context context) {
        super(context);
        initData();
    }
    ...
    private void initData() {
        ...
        list.add(getContext().getString(R.string.device_steamOvenOne_name_jiedong));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_shajun));
        this.dataList = list;
    ...
    private int chooseRes(int i, boolean isSelected) {
        ...
        switch (i) {
            case 0:
                ans = isSelected ? R.mipmap.jiedong_icon : R.mipmap.jiedong_icon;
                break;
            case 1:
                ans = isSelected ? R.mipmap.shajun_icon : R.mipmap.shajun_icon;
        ...
        public void drawSelf(Canvas canvas) {
            ...
            if (width < 28 || height < 28){
                ...
                if (itemText.length() == 4){
                    canvas.drawText(itemText, x + 25, y + move + unitHeight-20, textPaint);
                }else {
                    canvas.drawText(itemText, x + 50, y + move + unitHeight-20, textPaint);
                }
