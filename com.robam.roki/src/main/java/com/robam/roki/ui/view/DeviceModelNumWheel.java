 ...
 */
public class DeviceModelNumWheel extends View {
    ...
    public DeviceModelNumWheel(Context context, AttributeSet attrs,
                               int defStyle) {
    ...
    public DeviceModelNumWheel(Context context) {
        super(context);
        initData();
    }
        ...
        protected void drawSelf(Canvas canvas) {
            ...
            if (startx_offset != 0) {
                canvas.drawText(itemText + " " + unit, x + startx_offset - textRect.width() / 2, y + move + unitHeight / 2 + textRect.height() / 2,
                        textPaint);
            } else if (("123456").contains(itemText)) {
                canvas.drawText(itemText + " " + unit, x + controlWidth / 2 - textRect.width() / 2 - 60, y + move + unitHeight / 2 + textRect.height() / 2,
                        textPaint);
            } else {
