...
public final class PlayerView extends SimpleLayout
    ...
    private FrameLayout fragment_player_layout;
    ...
    public PlayerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mRelativeLayout=findViewById(R.id.rl_onprocessbar);
        ...
        fragment_player_layout=findViewById(R.id.fragment_player_layout);
    ...
    public void onPrepared(MediaPlayer player) {
        ...
        fragment_player_layout.setLayoutParams(params);
        if (mListener != null) {
