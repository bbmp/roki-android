...
/**
 * Created by lxb on 16/3/8.
 */
public class DeviceNormalSettingTemWheel
     extends View {
        ...
        public DeviceNormalSettingTemWheel(Context context, AttributeSet attrs,
                         int defStyle) {
        ...
        public DeviceNormalSettingTemWheel(Context context) {
            super(context);
            initData();
        }
        ...
        private void init(Context context, AttributeSet attrs) {
            ...
            //itemNumber = attribute.getInt(R.styleable.WheelView_itemNumber, 1);//
            itemNumber = 1;
        ...
        private class ItemObject {
            ...
            public void drawSelf(Canvas canvas) {
                ...
                // 绘制内容
                canvas.drawText(itemText +"°C", x + controlWidth / 2 - textRect.width()
