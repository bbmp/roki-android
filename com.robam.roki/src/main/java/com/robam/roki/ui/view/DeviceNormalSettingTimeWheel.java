...
/**
 * Created by lxb on 16/3/13.
 */
public class DeviceNormalSettingTimeWheel  extends View {
        ...
        public DeviceNormalSettingTimeWheel(Context context, AttributeSet attrs,
                         int defStyle) {
        ...
        public DeviceNormalSettingTimeWheel(Context context) {
            super(context);
            initData();
        }
...
//            itemNumber = 5;
        ...
        private class ItemObject {
            ...
            public void drawSelf(Canvas canvas) {
                ...
                // 绘制内容
                canvas.drawText(itemText + "min", x + controlWidth / 2 - textRect.width()
