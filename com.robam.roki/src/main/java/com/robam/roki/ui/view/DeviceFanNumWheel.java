...
public class DeviceFanNumWheel extends View {
    ...
    public DeviceFanNumWheel(Context context, AttributeSet attrs,
                             int defStyle) {
    ...
    public DeviceFanNumWheel(Context context) {
        super(context);
        initData();
    }
    ...
    protected void init(Context context, AttributeSet attrs) {
        ...
        heightDiv = (int) attribute.getDimension(
                R.styleable.WheelView_unitHight, 10);
...
//         drawMask(canvas);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogUtils.i("20190822", "controlWidth:" + controlWidth);
        if (controlWidth == 0) {
            controlWidth = 540;
        }
    ...
    protected void drawLine(Canvas canvas) {
        ...
        paint.setColor(0xffe9a60f);
//        if (Build.VERSION.SDK_INT >= 26 && Build.VERSION.SDK_INT < 27) {
//            canvas.drawLine(unitHeight * 5, controlHeight / 2 - unitHeight / 2, controlWidth, controlHeight / 2 - unitHeight / 2, paint);
//            canvas.drawLine(unitHeight * 5, controlHeight / 2 + unitHeight / 2, controlWidth, controlHeight / 2 + unitHeight / 2, paint);
//        } else {
            canvas.drawLine(unitHeight, controlHeight / 2 - unitHeight / 2, controlWidth - unitHeight - 16, controlHeight / 2 - unitHeight / 2, paint);
            canvas.drawLine(unitHeight, controlHeight / 2 + unitHeight / 2, controlWidth - unitHeight - 16, controlHeight / 2 + unitHeight / 2, paint);
//        }
    }
...
//            if (Build.VERSION.SDK_INT >= 26 && Build.VERSION.SDK_INT < 27) {
//                if (startx_offset != 0) {
//                    canvas.drawText(itemText + " " + unit, x + startx_offset + 130, y + move + unitHeight / 2 + textRect.height() / 2,
//                            textPaint);
//
//                } else {
//                    canvas.drawText(itemText + " " + unit, x + controlWidth / 2 + 130, y + move + unitHeight / 2 + textRect.height() / 2,
//                            textPaint);
//                }
//            } else {
