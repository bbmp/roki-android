...
// */
//
//public class DeviceFanOilCleanNewPage extends BasePage {
//    private AbsFan fan;
...
//        Preconditions.checkNotNull(fan, "id is null");
//        if (inflater == null)
//            inflater = LayoutInflater.from(cx);
//        contentView = inflater.inflate(R.layout.page_device_fan_oilclean_new, container, false);
