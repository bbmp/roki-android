...
//    static public final String AbsOvenCookMode = "AbsOvenCookMode";
    static public final String AbsOvenMode = "AbsOvenMode";
    static public final String AbsOvenMore = "AbsOvenMore";
...
//    static public final String DeviceCookerRecipe = "DeviceCookerRecipe";
...
//    static public final String DeviceSteam228 = "DeviceSteam228";//蒸箱228
    ...
    static public final String DeviceSteam228Working = "DeviceSteam228Working";
    static public final String DeviceOven039 = "DeviceOven";//电烤箱
    static public final String AbsOvenBakeDiyList = "AbsOvenBakeDiyList";
    static public final String AbsOvenBakeEdit = "AbsOvenBakeEdit";
    static public final String RecipeCook = "RecipeCook";
...
//    static public final String SterilizerWork = "SterilizerWork";//电烤箱
    ...
    //---------------------烤箱代码模块化---------------------
    static public final String AbsOven = "AbsOven";//电烤箱
    static public final String AbsOvenFanLinkage = "AbsOvenFanLinkage";//电烤箱
    static public final String DeviceOvenProfessionalSetting039 = "DeviceOvenProfessionalSetting";//电烤箱专业模式设置页面
    static public final String DeviceOven026ProfessionalSetting = "DeviceOven026ProfessionalSetting";//电烤箱专业模式设置页面
    static public final String DeviceOven028ProfessionalSetting = "DeviceOven028ProfessionalSetting";//电烤箱专业模式设置页面
    static public final String DeviceSteam226ProfessionalSetting = "DeviceSteam226ProfessionalSetting";//蒸箱226模式设置页面
    static public final String DeviceSteam275ProfessionalSetting = "DeviceSteam275ProfessionalSetting";//蒸箱226模式设置页面
    static public final String DeviceOven075ProfessionalSetting = "DeviceOven075ProfessionalSetting";//电烤箱专业模式设置页面
    static public final String DeviceSteam228ProfessionalSetting = "DeviceSteam228ProfessionalSetting";
    static public final String DeviceSteam228assistSetting = "DeviceSteam228assistSetting";
    static public final String DeviceOven026ExpSetting = "DeviceOven026ExpSetting";//电烤箱专业模式设置页面
    static public final String DeviceOven028Assist = "DeviceOven028Assist";//电烤箱专业模式设置页面 = "DeviceOven026ExpSetting";//辅助模式设置页面
    static public final String DeviceOvenWorking039 = "DeviceOvenWorking";
    static public final String DeviceOven026 = "DeviceOven026";//电烤箱
    static public final String DeviceOven028 = "DeviceOven028";//电烤箱
    static public final String DeviceOven026Main = "DeviceOven026Main";
    static public final String DeviceOven028Main = "DeviceOven028Main";
    static public final String DeviceOven026AutoSetting = "DeviceOven026AutoSetting";
    static public final String DeviceOven026Working = "DeviceOven026Working";
    static public final String DeviceOven028Working = "DeviceOven028Working";
    static public final String DeviceWaterPurifiy = "DeviceWaterPurifiy";//净水器
//    static public final String DeviceWaterPurifier312 = "DeviceWaterPurifier312";
//    static public final String DeviceWaterPurifier321 = "DeviceWaterPurifier321";
//    static public final String DeviceWaterPurifier320 = "DeviceWaterPurifier320";
    static public final String AbsDeviceWaterPurifier = "AbsDeviceWaterPurifier";
    static public final String SmartWaterPurifierParams = "SmartWaterPurifierParams";
...
//    static public final String DeviceWaterPurifiyControl = "DeviceWaterPurifiyControl";//净水器控制页面
    ...
    static public final String DeviceFan8229 = "DeviceFan8229";//8229烟机
    static public final String DeviceFan5610 = "DeviceFan5610";//5610烟机
    static public final String DeviceFan5910 = "DeviceFan5910";//5910烟机
    static public final String DeviceFan5910S = "DeviceFan5910S";
    static public final String DeviceFan9700 = "DeviceFan9700";//9700烟机
    static public final String DeviceFan8230 = "DeviceFan8230";//8230烟机
    static public final String DeviceFan8230s = "DeviceFan8230s";//8230s烟机
    static public final String DeviceFan8231s = "DeviceFan8231s";//8231s烟机
    static public final String DeviceFan8230c = "DeviceFan8230c";//8231s烟机
//    static public final String DeviceFan8700Oli = "DeviceFan8700Oli";//8700油网页面//66A2油网页面
//    static public final String DeviceFanOilClean = "DeviceFanOilClean";//5910
//    static public final String DeviceFanOilCleanNew = "DeviceFanOilCleanNew";//66A2油网页面
...
//    static public final String RecipeStep = "RecipeStep";
    ...
    static public final String RandomRecipe = "RandomRecipe";
    static public final String TellRoki = "TellRoki";
    static public final String TellRokiSucess = "TellRokiSucess";
    // 菜谱-----end

    //订单
//    static public final String OrderList = "OrderList";
//    static public final String OrderDetail = "OrderDetail";
...
//    static public final String SeriesInfoDetail = "SeriesInfoDetail";


//    static public final String Youzan = "Youzan";
//    static public final String YouzanOrder = "YouzanOrder";
//    static public final String YouzanTrolleyBus = "YouzanTrolleyBus";
    static public final String YouzanOrderDetails = "YouzanOrderDetails";
    static public final String DeviceMoreCook = "DeviceMoreCook";
...
//    static public final String UserLoginThird = "UserLoginThird"; //替换新的绑定手机号界面
    ...
    static public final String UserModifyName = "UserModifyName";
...
//    public static final String MineLogoffPage = "MineLogoffPage";
    ...
    public static final String MineSettingPasswordPage = "MineSettingPasswordPage";
    public static final String MineChangePasswordPage = "MineChangePasswordPage";
    public static final String MineCancelAccountPage = "MineCancelAccountPage";
...
//    static public final String MoreThomePage = "MoreThomePage";
    ...
    //上周榜单页面
    static public final String TopWeekPage = "TopWeekPage";
    //语音菜谱搜索界面
    static public final String SpeechRecipePage = "SpeechRecipePage";
...
//    static public final String RamdomCookBookPage = "RamdomCookBook";
    ...
    //应用烹饪曲线
    static public final String CurveCookbooksUser = "CurveCookbooksUser";
    //H5活动
...
//    static public final String RecipeDouGuo = "RecipeDouGuo";
    ...
    static public final String DeviceRikaOilDetection = "DeviceRikaOilDetection";
    static public final String DeviceRikaFanStoveLinkage = "DeviceRikaFanStoveLinkage";
    static public final String DeviceRikaFanStoveSterilizerLinkage = "DeviceRikaFanStoveSterilizerLinkage";
    static public final String DeviceRikaAppointmentElimination = "DeviceRikaAppointmentElimination";
...
//    static public final String Device90B8Z = "Device90B8Z";
     ...
     * 610多段菜谱
     */
    static public final String Multi610EditDetailPage = "Multi610EditDetailPage";
    static public final String Multi610RecipePage = "Multi610RecipePage";

    //多段菜谱
    static public final String MultiListRecipePage = "MultiListRecipePage";
    static public final String MultiAddEditDetailPage = "MultiAddEditDetailPage";

    //微波炉模块化
    static public final String AbsDeviceMicroWave = "AbsDeviceMicroWave";
    static public final String AbsMicroWaveMore = "AbsMicroWaveMore";
...
//    public static final String Local610Cookbook = "Local610Cookbook";
    ...
    public static final String MultiStepC908Mode = "MultiStepC908Mode";

    //RIKA
    public static final String DeviceRikaFanSteamOvenLinkage = "DeviceRikaFanSteamOvenLinkage";
    public static final String AbsRikaLocalRecipe = "AbsRikaLocalRecipe";


    //藏宝盒
    public static final String AbsHidKitDevicePage = "AbsHidKitDevicePage";
     ...
     * 集成灶主界面
     */
    static public final String AbsIntegratedStovePage = "AbsIntegratedStovePage";
    /**
     * 集成灶风量调节
     */
    static public final String IntegratedStoveAirVolumePage = "IntegratedStoveAirVolumePage";
    /**
     * 集成灶时间选择
     */
    static public final String IntegratedStoveModelSelected = "IntegratedStoveModelPage";
    /**
     * 集成灶烟灶联动
     */
    static public final String DeviceIntegStoveLinkagePage = "DeviceIntegStoveLinkagePage";
    /**
     * 集成灶本地自动菜谱
     */
    static public final String AbsIntegratedStoveLocalRecipePage = "AbsIntegratedStoveLocalRecipePage";
    /**
     * 集成灶本地自动菜谱详情
     */
//    public static final String LocalIntegStoveCookbookDetailPage = "LocalIntegStoveCookbookDetailPage";
     ...
     * 集成灶多段模式
     */
    static public final String MultiRecipePage = "MultiRecipePage";
    /**
     * 集成灶多段菜谱编辑
     */
    static public final String MultiEditDetailPage = "MultiEditDetailPage";
    /**
     * 集成灶工作界面
     */
    static public final String IntegratedStoveWorkPage = "IntegratedStoveWorkPage";
    /**
     * 集成灶更多界面
     */
