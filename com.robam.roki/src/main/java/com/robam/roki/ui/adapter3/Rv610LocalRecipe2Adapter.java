 ...
 * des 菜谱adapter
 */
public class Rv610LocalRecipe2Adapter extends BaseQuickAdapter<CookBookTag, BaseViewHolder> {
    ...
    public Rv610LocalRecipe2Adapter() {
    ...
    @Override
    protected void convert(@NotNull BaseViewHolder holder, CookBookTag item) {
        if (item != null){
