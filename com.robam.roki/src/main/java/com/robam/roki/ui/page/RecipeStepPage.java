...
//                            setInitStatus();
    ...
    private void setPreSetParamZKY(String type, short status, final Callback<Integer> callback) {
        ...
        if (steameOvenOne != null) {
            steameOvenOne.setSteameOvenStatus(steameOvenOne.powerStatus, status, new VoidCallback() {
                @Override
                public void onSuccess() {
...
*/
    ...
    public void onEvent(SteamOvenOneStatusChangedEvent event) {
        ...
        if (IRokiFamily.RC906.equals(event.pojo.getDt())) {
            ...
            if (event.pojo.powerStatus == 2 && event.pojo.powerOnStatus == 0 && flag906 && event.pojo.alarm == 0) {
                currentSec = -1;
                setInitStatus();
            }
            if (event.pojo.powerStatus == 2 && event.pojo.powerOnStatus == 0 && flag906 &&
            ...
            if (steamAndOven.worknStatus == SteamOvenOneWorkStatus.PreHeat) {//是否预热状态
