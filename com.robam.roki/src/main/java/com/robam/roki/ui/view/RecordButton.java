...
public class RecordButton extends View implements View.OnTouchListener {
     ...
     * 返回参数：录制时间太短
     */
    public static final int RECORD_SUCCESS = 2;
    /**
     * RecordButton的监听器
     */
     ...
     * 录制时间30s
     */
    private static final long RECORD_TIME_DEFAULT = 12000;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setBackgroundResource(R.mipmap.icon_roki_speak);
     ...
     * 手势抬起的时间用于点击判断
     */
    public void onActionUp2() {
//        //完成开关置为true
//        isDone = true;
//        isSuccess = true ;
//        //清除动画效果
//        clearAnimation();
        mRecordButtonListener.onLongClickFinish(RecordButton.RECORD_SUCCESS);
    }
    /**
     * 结束动作后执行的逻辑
     * 动画结束后的时间用于长按判断
