...
public class SteamDiyParamAdapter extends WheelView.WheelAdapter<TimeViewHolder> {
    private List<DeviceSteamDiyParams> deviceList;
    private String str;

    public SteamDiyParamAdapter(List<DeviceSteamDiyParams> deviceList, String str) {
