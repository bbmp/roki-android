...
import com.robam.roki.ui.action.StatusAction;
import com.robam.roki.ui.adapter3.ImageSelectAdapter;
import com.robam.roki.ui.manage.ThreadPoolManager;
import com.robam.roki.ui.widget.layout.StatusLayout;
import com.robam.roki.ui.widget.other.GridSpaceDecoration;
import com.robam.widget.view.FloatActionButton;
    ...
    public void onChildClick(RecyclerView recyclerView, View childView, int position) {
        if (childView.getId() == R.id.fl_image_select_check) {
            ...
            if (!file.isFile()) {
                ...
                toast(R.string.start_appointment_text);
                return;
            }
