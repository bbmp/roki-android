 ...
 */
public class DialogTypeFanSuop_11 extends BaseDialog {

    private TextView mTvCancel;
    private TextView mTvConfirm;

    public DialogTypeFanSuop_11(Context context) {
        super(context);
    }

    @Override
    public void initDialog() {
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.common_dialog_layout_type_11, null);
