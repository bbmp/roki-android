 ...
 */
public class DeviceOvenNormalSettingWheel extends View {
    ...
    public DeviceOvenNormalSettingWheel(Context context, AttributeSet attrs,
                                        int defStyle) {
    ...
    public DeviceOvenNormalSettingWheel(Context context) {
        super(context);
        initData();
    }
...
//            setMeasuredDimension(getWidth(), itemNumber * unitHeight - (itemNumber / 2) * (itemNumber / 2 + 1) * heightDiv);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        itemNumber = attribute.getInt(com.legent.ui.R.styleable.WheelView_itemNumber, 1);
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            // 绘制内容
            canvas.drawText(itemText, x + 100, y + move + unitHeight / 2 + textRect.height() / 2,
                    textPaint);
