...
public class RoundImageView extends ImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currMode = typedArray.hasValue(R.styleable.roundImageView_type) ? typedArray.getInt(R.styleable.roundImageView_type, MODE_NONE) : MODE_NONE;
        currRound = typedArray.hasValue(R.styleable.roundImageView_radiu) ? typedArray.getDimensionPixelSize(R.styleable.roundImageView_radiu, currRound) : currRound;
        typedArray.recycle();
    }
