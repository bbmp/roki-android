...
public class Microwave526WeightTimeSettingDialog1 extends AbsDialog {
    ...
    public static Microwave526WeightTimeSettingDialog1 dlg;
    Context cx;
    short model;//模式
    private View customView;
    MicroWaveM526 microWave;

    public Microwave526WeightTimeSettingDialog1(Context context, short model, AbsMicroWave microWave) {
    ...
    public void onClickStartCook() {
        if (listener != null && model >= 0) {
            listener.onConfirm(model, Short.valueOf(String.valueOf(fireNum.getSelectedTag())), Short.valueOf(String.valueOf(minites.getSelectedTag())), Short.valueOf(String.valueOf(second.getSelectedTag())));
        }
        if (dlg != null && dlg.isShowing())
            dlg.dismiss();
    }

    static public Microwave526WeightTimeSettingDialog1 show(Context context, short model, AbsMicroWave microWave) {
        dlg = new Microwave526WeightTimeSettingDialog1(context, model, microWave);
