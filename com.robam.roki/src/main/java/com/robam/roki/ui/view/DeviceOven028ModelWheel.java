...
public class DeviceOven028ModelWheel extends View {
     ...
     * 选择的内容
     */
    private List<DeviceOven028ModelWheel.ItemObject> itemList = Lists.newArrayList();
    /**
     * 设置数据
     */
     ...
     * 选择监听
     */
    private DeviceOven028ModelWheel.OnSelectListener onSelectListener;
    /**
     * 是否可用
     */
    ...
    public DeviceOven028ModelWheel(Context context, AttributeSet attrs,
                                  int defStyle) {
    ...
    public DeviceOven028ModelWheel(Context context) {
        super(context);
        initData();
    }
    ...
    private synchronized void drawList(Canvas canvas) {
        if (isClearing)
            return;
        try {
            for (DeviceOven028ModelWheel.ItemObject itemObject : itemList) {
    ...
    private void noEmpty() {
        if (!noEmpty)
            return;
        for (DeviceOven028ModelWheel.ItemObject item : itemList) {
            if (item.isSelected())
                return;
        }
    ...
    private void initData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            DeviceOven028ModelWheel.ItemObject itmItemObject = new DeviceOven028ModelWheel.ItemObject();
            itmItemObject.id = i;
    ...
    private int chooseRes(int i, boolean isSelected) {
        ...
        switch (i) {
            case 0:
                ans = isSelected ? R.mipmap.ic_oven028_recently_fasetheat_new : R.mipmap.ic_oven028_recently_fasetheat_new;
                break;
            case 1:
                ans = isSelected ? R.mipmap.ic_oven028_recently_fengbeikao_new : R.mipmap.ic_oven028_recently_fengbeikao_new;
                break;
            case 2:
                ans = isSelected ? R.mipmap.ic_oven028_recently_beikao : R.mipmap.ic_oven028_recently_beikao;
                break;
            case 3:
                ans = isSelected ? R.mipmap.ic_oven028_recently_bottomheat : R.mipmap.ic_oven028_recently_bottomheat;
                break;
            case 4:
                ans = isSelected ? R.mipmap.ic_oven028_recently_fengshankao: R.mipmap.ic_oven028_recently_fengshankao;
                break;
            case 5:
                ans = isSelected ? R.mipmap.ic_oven028_recently_kaosao : R.mipmap.ic_oven028_recently_kaosao;
                break;
            case 6:
                ans = isSelected ? R.mipmap.ic_oven028_recently_qingkaosao : R.mipmap.ic_oven028_recently_qingkaosao;
                break;
            case 7:
                ans = isSelected ? R.mipmap.ic_oven028_recently_kuaisuyure : R.mipmap.ic_oven028_recently_kuaisuyure;
                break;
            case 8:
                ans = isSelected ? R.mipmap.ic_oven028_recently_jiankao : R.mipmap.ic_oven028_recently_jiankao;
                break;
            case 9:
                ans = isSelected ? R.mipmap.ic_oven028_recently_guoshufry  : R.mipmap.ic_oven028_recently_guoshufry;
                break;
            case 10:
                ans = isSelected ? R.mipmap.img_oven028_baowen_mode  : R.mipmap.img_oven028_baowen_mode;
                break;
        }
        return ans;
    }
    ...
    public void setDefault(int index) {
        ...
        DeviceOven028ModelWheel.ItemObject item = itemList.get(index);
        onEndSelect(item);
    }
     ...
     */
    public void setOnSelectListener(DeviceOven028ModelWheel.OnSelectListener onSelectListener) {
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
          ...
          //  textPaint.getTextBounds(itemText, 0, itemText.length(), textRect);
            ...
            // 绘制内容
            bitmap = BitmapUtils.decodeSampledBitmapFromResource(getContext(), res, width, height);
            textPaint.getTextBounds(itemText, 0, itemText.length(), textRect);
            canvas.drawBitmap(bitmap, x + 40, y + move, null);
            canvas.drawText(itemText, x + 40, y + 10+move+bitmap.getHeight()+20,
                    textPaint);
    ...
    void onEndSelect(DeviceOven028ModelWheel.ItemObject item) {
        if (onSelectListener != null) {
            onSelectListener.endSelect(item.id, item.tag);
        }
    }

    void onSelecting(DeviceOven028ModelWheel.ItemObject item) {
        if (onSelectListener != null) {
