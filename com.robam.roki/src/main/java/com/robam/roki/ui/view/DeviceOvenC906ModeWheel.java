...
public class DeviceOvenC906ModeWheel extends View{
     ...
     * 选中的时候字体
     */
    private float selectedFont = 30.0f;
    /**
     * 单元格高度
     */
    ...
    public DeviceOvenC906ModeWheel(Context context, AttributeSet attrs,
                                  int defStyle) {
    ...
    public DeviceOvenC906ModeWheel(Context context) {
        super(context);
        initData();
    }
    ...
    private void initData() {
        ...
        list.add(getContext().getString(R.string.device_steamOvenOne_name_kuaisuyure));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_kuaire));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_fengpeikao));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_peikao));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_fengshankao));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_kaoshao));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_qiangshaokao));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_jiankao));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_dijiare));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_exp));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_guoshuhonggan));
        list.add(getContext().getString(R.string.device_steamOvenOne_name_baowen));
        this.dataList = list;
        for (int i = 0; i < dataList.size(); i++) {
            ...
            itmItemObject.x = 10;
            itmItemObject.y = i * unitHeight+20;
    ...
    private int chooseRes(int i, boolean isSelected) {
        ...
        switch (i) {
            case 0:
                ans = isSelected ? R.mipmap.img_device_oven_rapid_warm_906 : R.mipmap.img_device_oven_rapid_warm_906;
                break;
            case 1:
                ans = isSelected ? R.mipmap.img_device_oven_quick_heating_906 : R.mipmap.img_device_oven_quick_heating_906;
                break;
            case 2:
                ans = isSelected ? R.mipmap.img_device_oven_air_baking_906 : R.mipmap.img_device_oven_air_baking_906;
                break;
            case 3:
                ans = isSelected ? R.mipmap.img_device_oven_toast_906 : R.mipmap.img_device_oven_toast_906;
                break;
            case 4:
                ans = isSelected ? R.mipmap.img_device_oven_air_barbecue_906 : R.mipmap.img_device_oven_air_barbecue_906;
                break;
            case 5:
                ans = isSelected ? R.mipmap.img_device_oven_ferment_selected_906 : R.mipmap.img_device_oven_ferment_selected_906;
                break;
            case 6:
                ans = isSelected ? R.mipmap.img_device_oven_strong_barbecue_906 : R.mipmap.img_device_oven_strong_barbecue_906;
                break;
            case 7:
                ans = isSelected ? R.mipmap.img_device_oven_baked_906 : R.mipmap.img_device_oven_baked_906;
                break;
            case 8:
                ans = isSelected ? R.mipmap.img_device_oven_bottom_heating_906 : R.mipmap.img_device_oven_bottom_heating_906;
                break;
            case 9:
                ans = isSelected ? R.mipmap.img_device_oven_doubl_wen_shuang_control_906 : R.mipmap.img_device_oven_doubl_wen_shuang_control_906;
                break;
            case 10:
                ans = isSelected ? R.mipmap.img_device_oven_garden_stuff : R.mipmap.img_device_oven_garden_stuff;
                break;
            case 11:
                ans = isSelected ? R.mipmap.img_device_oven_keep_warm : R.mipmap.img_device_oven_keep_warm;
                break;
    ...
    public void setMapImg(Map<Integer, Integer> map) {
        this.mapImg = map;
    }

    private int chooseRes2(int i, boolean isSelected) {
        return mapImg.get(i);
    }
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            int res;
            if (mapImg.size() > 0) {
                res = chooseRes2(id, isSelected());
            } else {
                res = chooseRes(id, isSelected());
            }
            int width = 28;
            int height = 28;
            ...
            if (isSelected()) {
                ...
                float textSize = normalFont
                        ...
                        / (float) unitHeight));
                LogUtils.i("20171016","textSize:"+textSize);
            ...
            if (width < 28 || height < 28){
                ...
                canvas.drawBitmap(bitmap, x + 40, y + move+ 10 , null);
                if (itemText.length() == 4){
                    canvas.drawText(itemText, x + 22, y + move + unitHeight-20, textPaint);
                }else if (itemText.length() == 3){
                    canvas.drawText(itemText, x + 38, y + move + unitHeight-20, textPaint);
                }else if (itemText.length() == 2){
                    canvas.drawText(itemText, x + 48, y + move + unitHeight-20, textPaint);
                }

            }else {
                Bitmap bitmap = BitmapUtils.decodeSampledBitmapFromResource(getContext(), res, width, height);
                canvas.drawBitmap(bitmap, x + 40, y + move-10, null);
//            canvas.drawText(itemText, x + 40, y + move + unitHeight / 2 + textRect.height() / 2, textPaint);

                if(itemText.length() == 4){
                    canvas.drawText(itemText, x + 20, y + move + unitHeight, textPaint);
                }else if (itemText.length() == 3){
                    canvas.drawText(itemText, x + 38, y + move + unitHeight, textPaint);
                }else if (itemText.length() == 2){
                    canvas.drawText(itemText, x + 48, y + move + unitHeight, textPaint);
                }
    ...
    void onEndSelect(ItemObject item) {
        if (onSelectListener != null) {
            onSelectListener.endSelect(item.id + 1, item.tag);
