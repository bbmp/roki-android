...
//        RequestOptions options = new RequestOptions().centerCrop().placeholder(R.mipmap.img_default);
//
//        @Override
...
//            }
//            ImageUtils.displayImage(cx, live.imgUrl, viewHolder.imgView);
//            if (!StringUtils.isNullOrEmpty(live.imgUrl))
//                ImageUtils.displayImage(cx, live.imgUrl, viewHolder.imgView, options);
//            else
