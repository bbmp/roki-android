...
public class MyCircleProgress extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        _paint.setColor(SkinCompatResources.getColor(getContext() ,R.color.circle_color));
        //大圆的半径
        ...
        _paint.setColor(color == 0  ? SkinCompatResources.getColor(getContext() ,R.color.text_select_color) : color);
