...
public class DeviceNumWheel526 extends View {
    /**
     * 选择监听
     */
    ...
    public DeviceNumWheel526(Context context, AttributeSet attrs,
                          int defStyle) {
    ...
    public DeviceNumWheel526(Context context) {
        super(context);
        initData();
    }
...
//            setMeasuredDimension(getWidth(), itemNumber * unitHeight - (itemNumber / 2) * (itemNumber / 2 + 1) * heightDiv);
     ...
     */
    public void setOnSelectListener(DeviceNumWheel526.OnSelectListener onSelectListener) {
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            if (startx_offset != 0) {
                ...
                canvas.drawText(itemText + " " + unit, x + controlWidth / 2 - textRect.width() / 2, y + move + unitHeight / 2 + textRect.height() / 2,
                        textPaint);
            }
