...
public class DeviceMicrowave526TimeWheel extends View {
    /**
     * 选择监听
     */
    ...
    public DeviceMicrowave526TimeWheel(Context context, AttributeSet attrs,
                             int defStyle) {
    ...
    public DeviceMicrowave526TimeWheel(Context context) {
        super(context);
        initData();
    }
...
//            setMeasuredDimension(getWidth(), itemNumber * unitHeight - (itemNumber / 2) * (itemNumber / 2 + 1) * heightDiv);
    ...
    private void drawLine(Canvas canvas) {
       ...
       if (Build.VERSION.SDK_INT>=24){
           canvas.drawRect(0, controlHeight/3,controlWidth+unitHeight+270,controlHeight/2+70, paint);
       }else{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        unit = attribute.getString(com.legent.ui.R.styleable.WheelView_unit);
        attribute.recycle();
     ...
     */
    public void setOnSelectListener(DeviceMicrowave526TimeWheel.OnSelectListener onSelectListener) {
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            if (Build.VERSION.SDK_INT>= 24){
                if (startx_offset != 0) {
                    LogUtils.i("20170925","gg");
                    canvas.drawText(itemText + " " + unit, x + startx_offset, y + move + unitHeight / 2 + textRect.height() / 2,
                            textPaint);

                } else {
                    LogUtils.i("20170925","dd");
                    canvas.drawText(itemText + " " + unit, x + controlWidth / 2+100, y + move + unitHeight / 2 + textRect.height() / 2,
                            textPaint);
                }
