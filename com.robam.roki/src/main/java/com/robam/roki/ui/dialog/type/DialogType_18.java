 ...
 */
public class DialogType_18 extends BaseDialog {
    ...
    public DialogType_18(Context context) {
        super(context);
    }
    ...
    public void initDialog() {
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.common_dialog_layout_type_18, null);
