...
public class DialogType_13 extends BaseDialog {
    private TextView mCancelTv;
    private TextView mOkTv;
    private View mMiddleDivider;
    private TextView mContxt;
    public DialogType_13(Context context) {
        super(context);
    }

    @Override
    public void initDialog() {
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.commom_dialog_recipe_type_12_self, null);
