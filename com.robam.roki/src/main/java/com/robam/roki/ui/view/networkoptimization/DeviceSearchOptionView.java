...
public class DeviceSearchOptionView extends FrameLayout {

    public interface OnWordSelectedCallback {
        void onWordSelected(String word);
    }

    public DeviceSearchOptionView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public DeviceSearchOptionView(Context context, AttributeSet attrs, int defStyle) {
