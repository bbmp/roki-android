...
public class MicrowaveSettingDialog extends AbsDialog {
    ...
    public static MicrowaveSettingDialog dlg;
    Context cx;
    short model;//模式
    private View customView;
    AbsMicroWave microWave;

    public MicrowaveSettingDialog(Context context, short model, AbsMicroWave microWave) {
    ...
    protected int getViewResId() {
        return R.layout.dialog_microwave_setting;
    }
    ...
    static public MicrowaveSettingDialog show(Context context, short model, AbsMicroWave microWave) {
        dlg = new MicrowaveSettingDialog(context, model, microWave);
