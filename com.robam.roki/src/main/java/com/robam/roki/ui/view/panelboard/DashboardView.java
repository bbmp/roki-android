package com.robam.roki.ui.view.panelboard;
...
public class DashboardView extends View {
    ...
    public DashboardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRadius = a.getDimensionPixelSize(R.styleable.DashboardView_radiuss, dpToPx(80));
        ...
        mStripeWidth = a.getDimensionPixelSize(R.styleable.DashboardView_stripeWidths, 0);
