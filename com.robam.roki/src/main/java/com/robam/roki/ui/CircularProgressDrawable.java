...
public class CircularProgressDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float outerRadius = (size / 2) - (ringWidth / 2) ;//减去12是为了解决画圈动画不能够完全显示问题
        ...
        if (indeterminate) {
            ...
            canvas.drawArc(arcElements, progress, 270, false, paint);
        } else {
            //canvas.drawArc(arcElements, 89, progress, false, paint);
            canvas.drawArc(arcElements, 270, progress, false, paint);
        }
    }
