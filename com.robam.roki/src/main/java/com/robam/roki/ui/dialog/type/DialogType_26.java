...
public class DialogType_26 extends BaseDialog {

    private TextView mCancelTv;
    private Button mOkTv;
    protected Button mContxt;

    public DialogType_26(Context context) {
        super(context);
    }

    @Override
    public void initDialog() {
        View rootView = LayoutInflater.from(mContext).inflate(R.layout.common_dialog_recipe_type_26, null);
