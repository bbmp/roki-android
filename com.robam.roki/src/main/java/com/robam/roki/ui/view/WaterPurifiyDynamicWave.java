...
public class WaterPurifiyDynamicWave extends View {
    ...
    Canvas canvas;
    public WaterPurifiyDynamicWave(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        //创建bitmap
        Bitmap bitmap=Bitmap.createBitmap(mTotalWidth,mTotalHeight, Bitmap.Config.ARGB_8888);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            lg=new LinearGradient(i, mTotalHeight - mResetOneYPositions[i]- mTotalWidth/2, i, mTotalHeight, Color.WHITE, Color.parseColor("#3DB3D0"), Shader.TileMode.MIRROR);
