 ...
 *    desc   : 设置条自定义控件
 */
public final class SettingBar2 extends FrameLayout {
    ...
    public SettingBar2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SettingBar2(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public SettingBar2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLeftView.setPaddingRelative((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, getResources().getDisplayMetrics()));

        mRightView.setPaddingRelative((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 30, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0, getResources().getDisplayMetrics()),
        ...
        // 文字颜色设置
        setLeftColor(array.getColor(R.styleable.SettingBar_bar_leftColor, ContextCompat.getColor(getContext(), R.color.roki_important_text_color)));
        setRightColor(array.getColor(R.styleable.SettingBar_bar_rightColor, ContextCompat.getColor(getContext(), R.color.roki_important_text_color)));
     ...
     * 设置左边的标题
     */
    public SettingBar2 setLeftText(@StringRes int id) {
        return setLeftText(getResources().getString(id));
    }

    public SettingBar2 setLeftText(CharSequence text) {
     ...
     * 设置左边的提示
     */
    public SettingBar2 setLeftHint(@StringRes int id) {
        return setLeftHint(getResources().getString(id));
    }

    public SettingBar2 setLeftHint(CharSequence hint) {
     ...
     * 设置右边的标题
     */
    public SettingBar2 setRightText(@StringRes int id) {
        setRightText(getResources().getString(id));
        return this;
    }

    public SettingBar2 setRightText(CharSequence text) {
     ...
     * 设置右边的提示
     */
    public SettingBar2 setRightHint(@StringRes int id) {
        return setRightHint(getResources().getString(id));
    }

    public SettingBar2 setRightHint(CharSequence hint) {
     ...
     * 设置左边的图标
     */
    public SettingBar2 setLeftIcon(@DrawableRes int id) {
        setLeftIcon(ContextCompat.getDrawable(getContext(), id));
        return this;
    }

    public SettingBar2 setLeftIcon(Drawable drawable) {
     ...
     * 设置右边的图标
     */
    public SettingBar2 setRightIcon(@DrawableRes int id) {
        setRightIcon(ContextCompat.getDrawable(getContext(), id));
        return this;
    }

    public SettingBar2 setRightIcon(Drawable drawable) {
...
//        imageView.setImageDrawable(drawable);
     ...
     * 设置左标题颜色
     */
    public SettingBar2 setLeftColor(@ColorInt int color) {
     ...
     * 设置右标题颜色
     */
    public SettingBar2 setRightColor(@ColorInt int color) {
     ...
     * 设置左标题的文本大小
     */
    public SettingBar2 setLeftSize(int unit, float size) {
     ...
     * 设置右标题的文本大小
     */
    public SettingBar2 setRightSize(int unit, float size) {
     ...
     * 设置分割线是否显示
     */
    public SettingBar2 setLineVisible(boolean visible) {
     ...
     * 设置分割线的颜色
     */
    public SettingBar2 setLineColor(@ColorInt int color) {
        return setLineDrawable(new ColorDrawable(color));
    }
    public SettingBar2 setLineDrawable(Drawable drawable) {
     ...
     * 设置分割线的大小
     */
    public SettingBar2 setLineSize(int size) {
     ...
     * 设置分割线边界
     */
    public SettingBar2 setLineMargin(int margin) {
