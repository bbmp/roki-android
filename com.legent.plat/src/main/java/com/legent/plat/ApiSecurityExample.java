...
//            return BaseEncoding.base64().encode(hexArray);
    ...
    public static String hmacSha256ToURLEncoder(String KEY, String VALUE) {
        String hmacSha256ToURLEncoder="";
        try {
            Mac mac = Mac.getInstance("HmacSHA256");
            mac.init(new SecretKeySpec(KEY.getBytes("UTF-8"), "HmacSHA256"));
            byte[] signData = mac.doFinal(VALUE.getBytes("UTF-8"));
            String encodeStr = BaseEncoding.base64().encode(signData);

            hmacSha256ToURLEncoder = URLEncoder.encode(encodeStr,"UTF-8");
