...
public class StatusBar2Utils {
    ...
    public StatusBar2Utils(Activity activity) {
        mActivity = activity;
    }

    public static StatusBar2Utils with(Activity activity) {
        return new StatusBar2Utils(activity);
    }
    ...
    public StatusBar2Utils setColor(int color) {
        mColor = color;
        return this;
    }
    ...
    public StatusBar2Utils setDrawable(Drawable drawable) {
        mDrawable = drawable;
        return this;
    }
    ...
    public StatusBar2Utils setIsActionBar(boolean actionBar) {
     ...
     * @return
     */
    public StatusBar2Utils setDrawerLayoutContentId(boolean drawerLayout, int contentId) {
     ...
     * 去除 ActionBar 阴影
     */
    public StatusBar2Utils clearActionBarShadow() {
