...
public class IntegStoveAlarmCodeBean {
    ...
    public IntegStoveAlarmCodeBean(short stoveAlarmCode, short fanAlarmCode, short sterilAlarmCode, short steamAlarmCode, short steamOvenAlarmCode) {
