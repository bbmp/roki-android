...
public class YoukuPlayerView extends PluginOverlay implements DetailMessage,
	...
	private void initLayout() {
		...
		playback = findViewById(R.id.player_back);
		...
		playerDebugView = findViewById(R.id.surface_view_debug);
		surfaceBlack = findViewById(R.id.surface_black);

		spaceMiddle = findViewById(R.id.space_middle);
	...
	private void initPlayerBlank() {
		...
		rightSpace = findViewById(R.id.space_right);
		topSpace = findViewById(R.id.space_top);
		bottomSpace = findViewById(R.id.space_bottom);
	}
...
//				LinearLayout.LayoutParams.WRAP_CONTENT));
	...
	public void resizeVideoView(int percent, boolean force) {
		...
		RelativeLayout leftSpace = findViewById(R.id.space_left);
		RelativeLayout rightSpace = findViewById(R.id.space_right);
		RelativeLayout topSpace = findViewById(R.id.space_top);
		RelativeLayout bottomSpace = findViewById(R.id.space_bottom);
